...
const openApiSpec = {
  ...
  info: {
    title: 'KavPMS API',
    version: '1.0.0',
    description: 'Swagger documentation for the KavPMS property management API.',
  },
  ...
  components: {
    schemas: {
      ...
      RoomTypePerformanceItem: {
        ...
        required: ['id', 'name', 'baseRate', 'sold', 'avgRate', 'revenue', 'totalRooms', 'occPct'],
      },
      InitResponse: {
        type: 'object',
        properties: {
